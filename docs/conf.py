...
author = "Max Hully"
one_liner = "A Python package for tabulating ranked-choice elections."
...
man_pages = [(master_doc, "rcv", "rcv Documentation", [author], 1)]
...
texinfo_documents = [
    (master_doc, "rcv", "rcv Documentation", author, "rcv", one_liner, "Miscellaneous")
]
